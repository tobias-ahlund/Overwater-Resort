...
const budgetRoomCalendarContainer = document.querySelector(
  '.budget-room-calendar-container'
);
const standardRoomCalendarContainer = document.querySelector(
  '.standard-room-calendar-container'
);
const luxuryRoomCalendarContainer = document.querySelector(
  '.luxury-room-calendar-container'
);
...
const dropDownLoginForm = document.querySelector('.drop-down-field');

loginHeader.addEventListener('click', () => {
  dropDownLoginForm.classList.toggle('active');
});
...
const day31Budget = document.querySelector(
  '.budget-room-calendar .calendar-container ._31'
);
const day31InfoBudget = document.createElement('span');
day31InfoBudget.classList.add('day-31-info-budget');
day31InfoBudget.innerHTML =
  "Since February isn't yet available for reservations, it's not possible to stay the night of February 1.";
day31Budget.appendChild(day31InfoBudget);

const day31Standard = document.querySelector(
  '.standard-room-calendar .calendar-container ._31'
);
const day31InfoStandard = document.createElement('span');
day31InfoStandard.classList.add('day-31-info-standard');
day31InfoStandard.innerHTML =
  "Since February isn't yet available for reservations, it's not possible to stay the night of February 1.";
day31Standard.appendChild(day31InfoStandard);

const day31Luxury = document.querySelector(
  '.luxury-room-calendar .calendar-container ._31'
);
const day31InfoLuxury = document.createElement('span');
day31InfoLuxury.classList.add('day-31-info-luxury');
day31InfoLuxury.innerHTML =
  "Since February isn't yet available for reservations, it's not possible to stay the night of February 1.";
